           ...
           @foreach ($trx as $data)
            ...
            @switch($data->type)
               ...
               <div class="column w-full g-5">
                 <span class="u m-right-auto">Payment Receipt</span>
                <div onclick="window.open('{{ asset('receipts/'.$data->json->receipt ?? 'null'.'') }}')" class="m-right-auto pointer no-select row p-10 align-center justify-center br-5 bg-primary">
                    Open
                ...
                <div class="column w-full g-5">
                 <span class="u m-left-auto">Sender Name</span>
