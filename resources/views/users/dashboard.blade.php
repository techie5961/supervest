...
<img style="box-shadow:0 0 10px rgba(0,0,0,0.1)" src="{{ asset('banners/'.$banner_settings->earning_structure.'') }}" alt="Earning Structure Banner" class="w-full m-x-auto box-shadow max-w-500 br-10">
 ...
 <div style="box-shadow:0 0 10px rgba(0,0,0,0.1)" class="w-full row p-10 br-10 g-10 bg-light">
    ...
    <div onclick="spa(event,'{{ url('users/deposit') }}')" style="max-width:25% !important;background: linear-gradient(to bottom right,blue,rgb(1, 1, 97));color:white" class="w-full h-full p-5 br-10 column g-10 justify-center align-center">
     ...
     {{-- NAV --}}
    <div onclick="spa(event,'{{ url('users/withdraw') }}')" style="max-width:25% !important;background: linear-gradient(to bottom right,#4caf50,green);color:white" class="w-full h-full p-5 br-10 column g-10 justify-center align-center">
        <div style="background:rgba(255,255,255,0.2);color:white;" class="circle p-10 perfect-square column justify-center">
      ...
      {{-- NAV --}}
    <div onclick="spa(event,'{{ url('users/products') }}')" style="max-width:25% !important;background: linear-gradient(to bottom right,rgb(248, 102, 49),orangered);color:white" class="w-full h-full p-5 br-10 column g-10 justify-center align-center">
        <div style="background:rgba(255,255,255,0.2);color:white;" class="circle p-10 perfect-square column justify-center">
      ...
      {{-- NAV --}}
    <div onclick="spa(event,'{{ url('users/gift/code') }}')" style="max-width:25% !important;background: linear-gradient(to bottom right,purple,rgb(59, 1, 59));color:white" class="w-full h-full p-5 br-10 column g-10 justify-center align-center">
        <div style="background:rgba(255,255,255,0.2);color:white;" class="circle p-10 perfect-square column justify-center">
